...
results = model.train(data='data.yaml', epochs=10, batch=4, resume=True, imgsz=[1856, 844], lr0=0.05, lrf=0.0001,momentum=0.9)  # Ajusta el número de épocas según sea necesario<<<<<<<
